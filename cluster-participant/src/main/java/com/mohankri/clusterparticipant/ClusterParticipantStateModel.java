...
public class ClusterParticipantStateModel extends TransitionHandler {
...
/*    private final Message message;
    ...
    public ZNRecord update(ZNRecord currentData) {
      ...
      ZNRecord newRec = null;
/*
 = new ZNRecord(message.getResourceId().stringify());
  ...
  private static Logger LOG = Logger.getLogger(ClusterParticipantStateModel.class);
  ...
  public ClusterParticipantStateModel(HelixManager manager, String resource, String partition) {
...
*/
 /*   int startGen = Integer.parseInt(znRecord.getSimpleField("currentGen"));
    ...
    service.start();
    System.out.println(_serverId + " transitioned from " + message.getTypedFromState() + " to " + message.getTypedToState() + " for " + _partition);  */
  }
